        ...
        if choice == 1:
            if len(cart) < 10:
                ...
                if choice2 == 1:
                    try:
                        ...
                        print("Invalid input. Please enter a valid collar size.")
                    ...
                    try:
                        ...
                        print("Invalid input. Please enter a valid waist size.")
            ...
            if cart:
                ...
                if 1 <= remove <= len(cart):
                    ...
                    print("Invalid Item Number. Please enter a valid item number to remove.\n")

            else:
                print("Your Shopping Cart is Empty. Please add some items to the cart.\n")
            ...
            if cart:
                print(f"Your Total Bill is {total_price}\n")
                print("Payment Made Successfully. Thank you for shopping at our store.\n")
                break
